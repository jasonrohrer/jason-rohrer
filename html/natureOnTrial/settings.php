...
$databaseUsername = "jcr13_ntsbuser";
$databasePassword = "thistle";
$databaseName = "jcr13_natureontrial";

// The URL of the "homepage" of your seedBlogs site.
// Used in administrative emails.
$mainSiteURL = "http://www.northcountrynotes.org/jason-rohrer/natureOnTrial/index.php";

// The full URL to the seedBlogs.php script.
// Used in RSS feeds to uniquely point to specific posts.
$fullSeedBlogsURL = "http://www.northcountrynotes.org/jason-rohrer/natureOnTrial/seedBlogs.php";
...
$tableNamePrefix = "natureOnTrial_";
...
$siteName = "Nature On Trial";
// Used as the From address for administrative emails
$siteEmailAddress = "Nature On Trial <jcr13@users.sf.net>";
