...
// Shown to user after login.
// Used in administrative emails.
$mainSiteURL = "http://www.northcountrynotes.org/jason-rohrer/worklog/";

// The full URL to the seedBlogs.php script.
// Used in RSS feeds to uniquely point to specific posts.
$fullSeedBlogsURL =
    "http://www.northcountrynotes.org/jason-rohrer/worklog/seedBlogs.php";
...
$siteName = "interchangeable parts (Jason Rohrer's worklog)";
// Used as the From address for administrative emails
$siteEmailAddress = "Jason Rohrer <jcr13@users.sf.net>";
...
$siteShortName = "seedBlogs_jason_rohrer";
...
$storyBlockFormatClose = "</TABLE></TD></TR></TABLE>";


// HTML used to format headlines when intro text is shown
$headlineFormatOpen =
    "<TR><TD BGCOLOR=#D7EBCB VALIGN=TOP><FONT SIZE=4 COLOR=#2F4323>";
$headlineFormatClose = "</FONT></TD></TR>";
...
$textBlockFormatOpen = "<TR><TD BGCOLOR=#F8F8F8>";
$textBlockFormatClose = "</TD></TR>";
