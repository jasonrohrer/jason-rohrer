...
# correct for .wshtml files first
$fileName =~ s/wshtml/html/;
...
sub usage {
    ...
    print "  shtmlToHtml.pl order_file_name shtml_file_to_process ".
		"head_file_name\n";
    print "Example:\n";
    print "  shtmlToHtml.pl orderList.txt 0.shtml head.html\n";
    die;
    }
